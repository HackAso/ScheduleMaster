 ...
 */
public class WhoEnqueActivity extends AbstractActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_whoenqu);
        createSpinner();
        ImageView friendselect = (ImageView) findViewById(R.id.imageView3);
        ImageView entry = (ImageView) findViewById(R.id.imageView4);
    ...
    private void createSpinner() {
        ...
        Spinner spn = (Spinner)this.findViewById(R.id.spinnerWho);
        ...
        switch (requestCode) {
            case 0:
                try {
                    ...
                    TextView selectedTv = (TextView) findViewById(R.id.textView);
